<div>
    ...
    @endif
            ...
            @if ($activePaymentSetting == 'serviceSpecific')
                @if ($isRazorpayEnabled || $isStripeEnabled || $isFlutterwaveEnabled || $isPaypalEnabled || $isPayfastEnabled || $isPaystackEnabled || $isXenditEnabled || $isEpayEnabled || $enableOfflinePayment || $enableQrPayment)
