...
class PaymentSettings extends Component
{
    ...
    public function submitFormPaypal()
    {
        ...
        if (!$this->razorpayStatus && !$this->stripeStatus && !$this->flutterwaveStatus && !$this->paypalStatus && !$this->epayStatus) {
    ...
    public function submitFormPayfast()
    {
        ...
        if (!$this->razorpayStatus && !$this->stripeStatus && !$this->flutterwaveStatus && !$this->paypalStatus && !$this->paystackStatus && !$this->payfastStatus && !$this->epayStatus) {
            $this->enablePayViaCash = true;
        }
    }
    ...
    public function submitFormXendit()
    {
       if ($this->xenditStatus) {
        ...
        if (!$this->razorpayStatus && !$this->stripeStatus && !$this->flutterwaveStatus && !$this->paypalStatus && !$this->paystackStatus && !$this->payfastStatus && !$this->xenditStatus && !$this->epayStatus) {
            $this->enablePayViaCash = true;
        }
    }
